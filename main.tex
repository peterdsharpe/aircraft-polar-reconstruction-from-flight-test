...
\begin{document}
    ...
    $$s(t) = x(t) + n(t)$$ % TODO redo noise derviation
    ...
    \begin{figure}[H]
        \centering
        \includesvg{figures/aero_polar_form.svg}
...
%        where all parameters $\theta_i$ here are constrained in such a way that $0 \leq \eta_{\rm propulsive} \leq 1$ always.
    ...
    \begin{figure}[h]
        \centering
        \ifdraft{}{\includegraphics[]{figures/power_curve_with_physics.pdf}}
    ...
    \begin{figure}[h]
        \centering
        \ifdraft{}{\includegraphics[]{figures/aerodynamic_polar_with_physics.pdf}}
    ...
    \begin{figure}[h]
        \centering
        \ifdraft{}{\includegraphics[]{figures/propeller_polar_with_physics.pdf}}
