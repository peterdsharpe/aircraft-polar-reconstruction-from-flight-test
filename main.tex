...
%    \end{longtable*}}
    ...
    \begin{figure}[H]
        \centering
        \ifdraft{}{\includegraphics[page=1, width=\textwidth]{assets/seaway_mini_packet.pdf}}
